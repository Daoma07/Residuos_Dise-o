...
public class Productor extends Usuario {
    ...
    /**
     * Constructor de la clase Productor que recibe el nombre, el RFC y las credenciales del productor.
     *
    ...
    /**
     * Constructor de la clase Productor que recibe el ID, el nombre, el RFC y las credenciales del productor.
     *
